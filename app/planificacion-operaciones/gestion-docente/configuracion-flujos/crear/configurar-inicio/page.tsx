  ...
  return (
    <div className={`min-h-screen bg-gray-50 p-6 ${isPanelOpen ? "overflow-hidden h-screen" : ""}`}>
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Configurar Inicio de Flujo de la Actividad (GENERAL)  </h1>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6">
            <div className="space-y-2">
              <h2 className="text-xl font-semibold text-[#00a884]">Nuevo Flujo De Actividad </h2>

              <div className="flex items-center gap-2 text-gray-700">
                <span>
                  Categoría: <span className="font-medium text-[#004fff]">GENERAL</span> - Disparador de inicio: Evento
                  del Sistema
                </span>
              </div>
            </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <p className="text-sm text-purple-600">
                          Puedes usar plantillas disponibles para la Subactividad Seleccionada
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-[#004fff] ml-8">
                      La primera Subactividad usa el disparador de inicio configurado. Las siguientes usan ocurrencias o fecha fija.
                    </p>
                  </div>

                  {/* Opción 1: Sí, es la primera actividad */}
                  <div
                    className={`p-4 rounded-lg border-2 transition-colors ${
                      tipoDisparador === "primera-actividad" ? "border-[#004fff] bg-blue-50" : "border-gray-200"
                    }`}
                  >
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        type="radio"
                        name="tipoDisparador"
                        checked={tipoDisparador === "primera-actividad"}
                        onChange={() => setTipoDisparador("primera-actividad")}
                        className="w-4 h-4 mt-1 text-[#004fff] border-gray-300 focus:ring-[#004fff]"
                      />
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-gray-800">Sí, es la primera Subactividadad</span>
                        </div>
                        <p className="text-sm text-gray-500 mt-1">
                          Usa el disparador de inicio configurado para el flujo
                        </p>

                        {tipoDisparador === "primera-actividad" && (
                          <div className="mt-4 space-y-3">
                            ...
                            {fechaFija && horaFija && (
                              <p className="text-sm text-green-600">
                                ...
                                <span className="font-medium">
                                  {new Date(fechaFija).toLocaleDateString("es-ES", {
                                    day: "numeric",
                                    month: "long",
                                    year: "numeric",
                                  })}{" "}
                            ...
                            {!fechaFija && !horaFija && (
                              <p className="text-sm text-gray-500">
                                La fecha y hora en la que se ejecutara el disparador se seleccionara al crear la oportunidad del docente
                              </p>
                            )}
                          </div>
                        )}
                  ...
                  {/* Opción 2: No, basado en ocurrencia anterior */}
                  <div
                    className={`p-4 rounded-lg border-2 transition-colors ${
                      tipoDisparador === "ocurrencia-anterior" ? "border-[#004fff] bg-blue-50" : "border-gray-200"
                    }`}
                  >
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        type="radio"
                        name="tipoDisparador"
                        checked={tipoDisparador === "ocurrencia-anterior"}
                        onChange={() => setTipoDisparador("ocurrencia-anterior")}
                        className="w-4 h-4 mt-1 text-[#004fff] border-gray-300 focus:ring-[#004fff]"
                      />
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                        ...
                        {tipoDisparador === "ocurrencia-anterior" && (
                          <div className="mt-4 space-y-3">
                            <div className="flex items-center gap-3">
                              <Input
                                type="number"

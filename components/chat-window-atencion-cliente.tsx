    ...
    <div className="flex-1 flex flex-col h-full">
      ...
      {activeTab === "crm" && (
        <div className="p-4 bg-slate-50">
          ...
          {/* Action button */}
          <Button
            onClick={() => router.push(`/atencion-cliente/gestion/agenda/contacto-entrante/${user.id}`)}
            className="w-full bg-green-600 hover:bg-green-700 mb-3"
          >
            Ir a ficha
          </Button>

          {/* New Finalizar actividad button */}
          <Button
            onClick={() => {
              // Handle finalize activity logic here
              console.log("Finalizar actividad clicked for user:", user.id)
            }}
